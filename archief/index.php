...
<!--               <button class="btn btn-success btn-block">New Project
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.html">
              ...
              <span class="menu-title">Upcoming launch</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              <i class="menu-icon mdi mdi-content-copy"></i>
              <span class="menu-title">Last Launch</span>
...
<!--             <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="pages/ui-features/typography.html"></a>
                </li>
              </ul>
            </div>
          </li>
...
<!--                       <i class="mdi mdi-cube text-danger icon-lg"></i> -->
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Name mission</p>
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0 mission-name"></h3>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    <div class="float-left">
                      <i class="mdi mdi-timer text-warning icon-lg"></i>
                    </div>
                    <div class="float-right">
                      <p class="mb-0 text-right">Time untill liftoff</p>
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0 timer"></h3>
                      </div>
                    </div>
                  </div>
<!--                   <p class="text-muted mt-3 mb-0">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    <div class="float-left">
                      <i class="mdi mdi-face-agent-box text-success icon-lg"></i>
                    </div>
                    <div class="float-right">
                      <p class="mb-0 text-right">Name costumer</p>
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0 name-costumer"></h3>
                      </div>
                    </div>
                  </div>
<!--                   <p class="text-muted mt-3 mb-0">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    <div class="float-left">
                      <i class="mdi mdi-weight-kilogram text-info icon-lg"></i>
                    </div>
                    <div class="float-right">
                      <p class="mb-0 text-right">payload</p>
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0"><span class="payload-mass"></span> KG</h3>
                      </div>
                    </div>
                  </div>
<!--                   <p class="text-muted mt-3 mb-0">
          ...
          <div class="row">
            <div class="col-lg-7 grid-margin stretch-card imageslider">
              <img src="images/ocisly.jpg">
              <!--weather card-->
<!--               <div class="card card-weather">
            ...
            <div class="col-lg-5 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title text-primary mb-5">landing info</h2>
                  <div class="wrapper d-flex justify-content-between">
                    <div class="side-left">
                      <p class="mb-2 ">Will they attempt to land?</p>
                      <p class="display-3 mb-4 font-weight-light land-intent"></p>
                    </div>
...
<!--                       <small class="text-muted">2017</small> -->
                  ...
                  <div class="wrapper d-flex justify-content-between">
                    <div class="side-left">
                      <p class="mb-2">Where will it land?</p>
                      <p class="display-3 mb-5 font-weight-light landing-place"></p>
                    </div>
                    <div class="side-right">
<!--                       <small class="text-muted">2015</small> -->
                  ...
                  <div class="wrapper d-flex justify-content-between">
                      <div class="side-left">
                        <p class="mb-2">How many times did they land?</p>
                        <p class="display-3 mb-5 font-weight-light landing-place"></p>
                      </div>
                      <div class="side-right">
  <!--                       <small class="text-muted">2015</small> -->
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
                <div class="card card-statistics">
                  <div class="card-body">
                    <div class="clearfix">
                      <div class="float-left">
                        <i class="mdi mdi-rocket text-danger icon-lg"></i>
                      </div>
                      <div class="float-right">
                        <p class="mb-0 text-right">Type rocket</p>
                        <div class="fluid-container">
                          <h3 class="font-weight-medium text-right mb-0 rocket-name"></h3>
                        </div>
                      </div>
                    </div>
<!--                     <p class="text-muted mt-3 mb-0">
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
                <div class="card card-statistics">
                  <div class="card-body">
                    <div class="clearfix">
                      <div class="float-left">
                        <i class="mdi mdi-satellite-variant text-warning icon-lg"></i>
                      </div>
                      <div class="float-right">
                        <p class="mb-0 text-right">Where will the satalite be?</p>
                        <div class="fluid-container">
                          <h3 class="font-weight-medium text-right mb-0 orbit-sat"></h3>
                        </div>
                      </div>
                    </div>
<!--                     <p class="text-muted mt-3 mb-0">
...
<!--                         <i class="mdi mdi-poll-box text-success icon-lg"></i> -->
                      ...
                      <div class="float-right">
                        <p class="mb-0 text-right">Launch site</p>
                        <div class="fluid-container">
                          <h3 class="font-weight-medium text-right mb-0 launch-site"></h3>
                        </div>
                      </div>
                    </div>
<!--                     <p class="text-muted mt-3 mb-0">
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
                <div class="card card-statistics">
                  <div class="card-body">
                    <div class="clearfix">
                      <div class="float-left">
                        <i class="mdi mdi-counter text-info icon-lg"></i>
                      </div>
                      <div class="float-right">
                        <p class="mb-0 text-right">Total launches</p>
                        <div class="fluid-container">
                          <h3 class="font-weight-medium text-right mb-0 total-launches"></h3>
                        </div>
                      </div>
                    </div>
<!--                     <p class="text-muted mt-3 mb-0">
